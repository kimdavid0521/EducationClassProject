package com.example.EducationClassProject.apiPayload;

import com.example.EducationClassProject.apiPayload.code.BaseCode;
import com.example.EducationClassProject.apiPayload.code.status.SuccessState;
...
public class BaseResponse<T> {
    ...
    public static <T> BaseResponse<T> onSuccess(T result) {
        return new BaseResponse<>(true, SuccessState._OK.getCode(), SuccessState._OK.getMessage(), result);
    }
